(function() {
    ...
    Orpheus.create = function() {
      ...
      OrpheusModel = (function(_super) {
        ...
        function OrpheusModel(name, q) {
          ...
          this.validations = [];
          this.fields = ['str', 'num', 'list', 'set', 'zset'];
          _ref = this.fields;
          _fn = function(f) {
            return _this[f] = function(field, options) {
              if (options == null) options = {};
              if (this.model[field]) throw new Error("Field name already taken");
              this.model[field] = {
                type: f,
                options: options
              };
        ...
        OrpheusModel.prototype.id = function(id, fn) {
          ...
          if (!id || _.isString(id) || _.isNumber(id)) {
            if (fn) {
              return fn(null, new OrpheusAPI(id, this));
            } else {
            ...
            for (k in id) {
              ...
              _results.push(this.redis.hget("" + this.prefix + ":" + this.pname + ":map:" + pk, v, function(err, model_id) {
                ...
                if (model_id) {
                  return fn(null, new OrpheusAPI(model_id, _this));
                } else {
                  model = new OrpheusAPI(null, _this);
                  model.add_map(pk, v);
                  return fn(null, model, 'new user');
                }
              }));
            }
            return _results;
  ...
  OrpheusAPI = (function() {
    ...
    function OrpheusAPI(id, model) {
      var f, key, prel, rel, value, _fn, _fn2, _fn3, _fn4, _i, _j, _k, _l, _len, _len2, _len3, _len4, _ref, _ref2, _ref3, _ref4, _ref5,
        _this = this;
      this.model = model;
      ...
      for (key in _ref3) {
        ...
        _fn3 = function(key, f) {
          _this[key][f] = function() {
            ...
            if (_this.model[key].options.map) _this.extra_commands(key, f, args);
            return _this;
          };

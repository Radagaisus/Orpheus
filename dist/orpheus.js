...
(function() {
  ...
  OrpheusAPI = (function() {
    ...
    OrpheusAPI.prototype.delete_model = function() {
      var hdel_flag, key, type, value, _ref, _results;
      hdel_flag = false;
      _ref = this.model;
      _results = [];
      for (key in _ref) {
        ...
        if (type === 'str' || type === 'num') {
          if (!hdel_flag) {
            hdel_flag = true;
            _results.push(this._commands.push(['del', this._get_key()]));
          } else {
            _results.push(void 0);
          }
        } else {
          _results.push(this._commands.push(['del', this._get_key(key)]));
        }
      }
      return _results;
    };
    ...
    OrpheusAPI.prototype._create_getter_object = function(res) {
      var dynamic_key, field, i, index, member, new_res, s, temp_res, zset, _i, _j, _len, _len1, _name, _ref, _ref1;
      new_res = {};
      temp_res = {};

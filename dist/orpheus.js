...
(function() {
  var EventEmitter, Orpheus, OrpheusAPI, OrpheusValidationErrors, async, command_map, commands, getters, hooks, inflector, log, os, validation_map, validations, _,
  ...
  OrpheusAPI = (function() {
    ...
    function OrpheusAPI(id, model) {
      var f, k, key, prel, rel, type, value, _fn, _fn1, _fn2, _fn3, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      this.model = model;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _fn1 = function(prel, f) {
          _this[prel][f] = function() {
            var args, fn, _l;
            args = 2 <= arguments.length ? __slice.call(arguments, 0, _l = arguments.length - 1) : (_l = 0, []), fn = arguments[_l++];
      ...
      for (key in _ref2) {
        value = _ref2[key];
        this[key] = {};
        for (_l = 0, _len3 = hooks.length; _l < _len3; _l++) {
          k = hooks[_l];
          this[key][k] = hooks[k];
        }
        ...
        _fn2 = function(key, f, type) {
          _this[key][f] = function() {
            var args, result, v, _len5, _n, _ref4;
            ...
            if (__indexOf.call(getters, f) >= 0) {
              _this._res_schema.push({
                position: _this._commands.length - 1,
                type: type,
                name: key,
